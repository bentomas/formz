...
import formz_lustre/generator
import formz_string/definition as string_definition
import formz_string/generator as string_generator
import gleeunit
...
pub fn three_field_form_test() {
  let html = three_field_form() |> generator.build |> convert_to_string
  let string_html = three_field_string_form() |> string_generator.build
